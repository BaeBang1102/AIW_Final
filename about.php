...
<head>
    ...
    <!-- Title -->
    <title>Rainbow Group &amp; Introduction</title>
                    ...
                    <div class="about-us-content bg-white mb-30 p-30 box-shadow">
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="img/bg-img/huong1.jpg" alt="">
                            ...
                            <div class="team-member-content">
                                <h6>Nguyen Minh Huong</h6>
                                <span>Front-end</span>
                                <p>She is only girl in group.</p>
                            </div>
                        </div>
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="img/bg-img/anh.jpg" alt="">
                                <div class="social-btn">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="img/bg-img/hai.jpg" alt="">
                                <div class="social-btn">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                        ...
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="img/bg-img/tung.jpg" alt="">
                                <div class="social-btn">
                                    <a href="https://www.facebook.com/my.username.22222"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="https://twitter.com/chunnieeeee1102/"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                </div>
                            </div>
                            <div class="team-member-content">
                                <h6>Nguyen Duy Tung</h6>
                                <span>Back-end</span>
                                <p>Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka Ez katka </p>
                            </div>
                        </div>
                        <!-- Single Team Member -->
                        <div class="single-team-member d-flex align-items-center">
                            <div class="team-member-thumbnail">
                                <img src="img/bg-img/lam.jpg" alt="">
                                <div class="social-btn">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
